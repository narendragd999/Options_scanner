...
gain_threshold = st.sidebar.slider("Gain % Threshold", min_value=100, max_value=3000, value=500, step=50)
...
# Display Table
st.dataframe(df_filtered[['TICKER', 'EXPIRY', 'TYPE', 'STRIKE PRICE','CLOSE_PRIC', 'GAIN_PERCENT']])
